...
SECRET_KEY = 'django-insecure-#sr4v_kn)w*l_#_l5u+!h=1kvobt1kw6lmfdt_*ls+1#w40k5#'
...
# Add REST framework settings (optional, modify as per your needs)
REST_FRAMEWORK = {
...
DATABASES = {
    ...
    'default': {
        ...
        'USER': 'gaurav',  # Replace with your PostgreSQL username
